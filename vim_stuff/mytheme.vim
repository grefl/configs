...
" Default colors
set background=dark
let s:bg = { 'gui': '#22272e', 'cterm': 'none' }
let s:fg = { 'gui': '#adbac7', 'cterm': 231 }
let s:invisibles = { 'gui': '#65738e', 'cterm': 66 }
let s:comments = { 'gui': '#cfd9e5', 'cterm': 145 }
...
let s:red = { 'gui': '#adbac7', 'cterm': 203 }
...
let s:blue = { 'gui': '#dcbdfb', 'cterm': 111 }
let s:paleblue = { 'gui': '#b2ccd6', 'cterm': 152 }
let s:purple = { 'gui': '#f47067', 'cterm': 176 }
let s:brown = { 'gui': '#c17e70', 'cterm': 137 }
let s:pink = { 'gui': '#f07178', 'cterm': 204 }
let s:violet = { 'gui': '#bb80b3', 'cterm': 139 }
" my themes
let s:n_blue = { 'gui': '#6cb6ff', 'cterm': 111 }
let s:light_blue = { 'gui': '#96d0ff', 'cterm': 111 }
...
call s:SetHighlight('String', s:light_blue, '', '')
...
call s:SetHighlight('javaScriptFunction', s:purple, '', '')
call s:SetHighlight('javaScriptFuncCall', s:n_blue, '', '')
...
" Yaml
call s:SetHighlight('yamlBlockMappingKey', s:pink, '', '')
...
call s:SetHighlight('rustSelf', s:n_blue, '', '')
call s:SetHighlight('rustEnumVariant', s:n_blue, '', '')
call s:SetHighlight('rustCharacter', s:light_blue, '', '')
